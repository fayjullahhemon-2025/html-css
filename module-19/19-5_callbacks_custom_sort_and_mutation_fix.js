...
const numArr = [1, 10, 2, 25, 3];
// console.log(sortDescending(numArr));
// console.log(numArr);
...
//   return cart.map((item) => {
//         let price = item.price - item.price * 0.1; 
//         return {name: item.name, price:price};
//   });
    return cart.map((item)=>{
        return {
            ...item,//spread operator diye array er vitorer object ke independent krsi
